...
async function modifyLimitOrder({ orderId, pair, newPrice }) {
    ...
    try {
        ...
        console.log('response',response.status, 'id', response.data.id)
...
let orderId = '93185937-54bc-41ad-b4b6-c0e97a42ce10';
let pair = 'USDTZAR'
let newPrice = '11'
modifyLimitOrder({ orderId , pair, newPrice });
